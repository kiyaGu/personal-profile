...
const github = new GitHubApi({
    headers: {
        //to get the decoded content of the readme files
...
app.use(function(req, res, next) {
    ...
    if (cookie === undefined) {
        ...
        res.cookie("currentPlayer", randomNumber, {
...
app.get("/", (req, res) => {
    ...
    mathGame(given => {
        ...
        readPlayersCollection().then(playersFile => {
            //after getting the players list with their score
            ...
            github.repos
                .getAll({}) //collect the repos
                .then(repos => {
                    //serve the index view with the given variables
                    res.render("index", {
                        repos: repos.data,
                        inputGiven: given,

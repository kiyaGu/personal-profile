$(document).ready(function() {
    ...
    TweenMax.staggerFrom('.hire-me button', 14, { y: 0, opacity: 0, delay: 23, rotation: 90, scale: 0.1, ease: Back.easeIn });
    TweenMax.staggerFrom('#hire-me-top-hr', 14, { y: 0, opacity: 0, delay: 37, scale: 0.2, ease: Back.easeOut });
    TweenMax.staggerFrom('#hire-me-bottom-hr', 14, { y: 0, opacity: 0, delay: 37, scale: 0.2, ease: Back.easeOut });
